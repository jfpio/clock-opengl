...
void Floor::setVertices(std::vector<Vertex> &vertices, std::vector<GLuint> &indices)
{
	vertices.push_back(Vertex(vec3(-0.5f, 0.5f, 0.5), vec3(0.5f, 0.5f, 0.5f), vec2(0.0f, 0.0f)));
